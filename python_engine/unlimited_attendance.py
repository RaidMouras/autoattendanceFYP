...
def mark_log(student_id, name, status_label):
    ...
    try:
        ...
        # SQL Query handles both cases:
        # If student_id is valid, it saves it.
        # If student_id is None (Unknown), it saves NULL in that column.
        insert_sql = """
        ...
        # Print a different message depending on who it is
        if student_id:
...
def run_test_system():
    ...
    # We continue even if no students are found, so we can test "Unknown" detection
